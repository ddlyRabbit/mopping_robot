...
if("TRUE" STREQUAL "TRUE")
  set(depth_sensor_pose_SOURCE_PREFIX /home/ubuntu/mopping_robot/ros/src/depth_nav_tools/depth_sensor_pose)
  set(depth_sensor_pose_DEVEL_PREFIX /home/ubuntu/mopping_robot/ros/devel)
  ...
  set(depth_sensor_pose_INSTALL_PREFIX /home/ubuntu/mopping_robot/ros/install)
...
if(NOT "/home/ubuntu/mopping_robot/ros/devel/include;/home/ubuntu/mopping_robot/ros/src/depth_nav_tools/depth_sensor_pose/include " STREQUAL " ")
  set(depth_sensor_pose_INCLUDE_DIRS "")
  set(_include_dirs "/home/ubuntu/mopping_robot/ros/devel/include;/home/ubuntu/mopping_robot/ros/src/depth_nav_tools/depth_sensor_pose/include")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'depth_sensor_pose' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/ubuntu/mopping_robot/ros/src/depth_nav_tools/depth_sensor_pose/${idir}'.  ${_report}")
    endif()
    _list_append_unique(depth_sensor_pose_INCLUDE_DIRS ${include})
  endforeach()
endif()

set(libraries "DepthSensorPose;DepthSensorPoseNode")
...
set(depends "roscpp;image_geometry;image_transport;nodelet;dynamic_reconfigure;sensor_msgs;pcl_ros;cmake_modules;costmap_2d")
