...
echo_and_run cd "/home/ubuntu/mopping_robot/ros/src/rosserial/rosserial_vex_cortex"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python2" \
    "/home/ubuntu/mopping_robot/ros/src/rosserial/rosserial_vex_cortex/setup.py" \
     \
    build --build-base "/home/ubuntu/mopping_robot/ros/build/rosserial/rosserial_vex_cortex" \
    install \
    --root="${DESTDIR-/}" \
