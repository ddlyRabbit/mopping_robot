...
echo_and_run cd "/home/ubuntu/mopping_robot/ros/src/rosserial/rosserial_client"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python2" \
    "/home/ubuntu/mopping_robot/ros/src/rosserial/rosserial_client/setup.py" \
     \
    build --build-base "/home/ubuntu/mopping_robot/ros/build/rosserial/rosserial_client" \
    install \
    --root="${DESTDIR-/}" \
